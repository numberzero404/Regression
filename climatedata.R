climate <- read.table(file="C:/Users/lynsi/Desktop/Stat 330/Climate.txt", header=TRUE)
scatter.smooth(climate$co2, climate$globaltemp, pch=19, main="CO2 Emissions and Global
